...
class Account extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('acc_name, acc_type', 'length', 'max'=>100),
			array('acc_balance', 'length', 'max'=>10),
	...
	public function relations()
	{
		...
		return array(
			...
			'transactions' => array(self::HAS_MANY, 'Transaction', 'acc_id'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('acc_balance',$this->acc_balance,true);
