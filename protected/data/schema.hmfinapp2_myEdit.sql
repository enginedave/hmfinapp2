...
CREATE TABLE `tbl_account` (
  ...
  `acc_name` VARCHAR(100) NULL DEFAULT NULL,
  `acc_type` VARCHAR(100) NULL DEFAULT NULL,
  `acc_balance` DECIMAL(10,2) NULL DEFAULT NULL,
  `create_time` DATETIME NULL DEFAULT NULL,
  `create_user_id` INTEGER NULL DEFAULT NULL,
  `update_time` DATETIME NULL DEFAULT NULL,
  `update_user_id` INTEGER NULL DEFAULT NULL,
...
CREATE TABLE `tbl_payee` (
  `id` INTEGER NULL AUTO_INCREMENT DEFAULT NULL,
  `user_id` INTEGER NULL DEFAULT NULL,
  `pay_name` VARCHAR(100) NULL DEFAULT NULL,
  `create_time` DATETIME NULL DEFAULT NULL,
  `create_user_id` INTEGER NULL DEFAULT NULL,
  `update_time` DATETIME NULL DEFAULT NULL,
  `update_user_id` INTEGER NULL DEFAULT NULL,
...
INSERT INTO `tbl_account` (`user_id`,`acc_name`,`acc_type`,`acc_balance`,`create_time`,`create_user_id`,`update_time`,`update_user_id`) VALUES ('1','Santander','Current','1234.56','','','','');
INSERT INTO `tbl_account` (`user_id`,`acc_name`,`acc_type`,`acc_balance`,`create_time`,`create_user_id`,`update_time`,`update_user_id`) VALUES ('1','Santander','Saving','789.56','','','','');
INSERT INTO `tbl_account` (`user_id`,`acc_name`,`acc_type`,`acc_balance`,`create_time`,`create_user_id`,`update_time`,`update_user_id`) VALUES ('1','Nationwide','ISA','999.00','','','','');

INSERT INTO `tbl_payee` (`user_id`,`pay_name`,`create_time`,`create_user_id`,`update_time`,`update_user_id`) VALUES ('1','Tesco','','','','');
INSERT INTO `tbl_payee` (`user_id`,`pay_name`,`create_time`,`create_user_id`,`update_time`,`update_user_id`) VALUES ('1','Marks and Spencer','','','','');
INSERT INTO `tbl_payee` (`user_id`,`pay_name`,`create_time`,`create_user_id`,`update_time`,`update_user_id`) VALUES ('1','Artie Grass','','','','');
INSERT INTO `tbl_payee` (`user_id`,`pay_name`,`create_time`,`create_user_id`,`update_time`,`update_user_id`) VALUES ('1','Muff Service Station','','','','');

INSERT INTO `tbl_category` (`user_id`,`cat_name`,`create_time`,`create_user_id`,`update_time`,`update_user_id`) VALUES ('1','Food:Groceries','','','','');
INSERT INTO `tbl_category` (`user_id`,`cat_name`,`create_time`,`create_user_id`,`update_time`,`update_user_id`) VALUES ('1','Food:Dining Out','','','','');
INSERT INTO `tbl_category` (`user_id`,`cat_name`,`create_time`,`create_user_id`,`update_time`,`update_user_id`) VALUES ('1','House:Grass Cutting','','','','');
INSERT INTO `tbl_category` (`user_id`,`cat_name`,`create_time`,`create_user_id`,`update_time`,`update_user_id`) VALUES ('1','House:Accessories','','','','');
INSERT INTO `tbl_category` (`user_id`,`cat_name`,`create_time`,`create_user_id`,`update_time`,`update_user_id`) VALUES ('1','Car:Fuel','','','','');
INSERT INTO `tbl_category` (`user_id`,`cat_name`,`create_time`,`create_user_id`,`update_time`,`update_user_id`) VALUES ('1','Charitable:Church','','','','');
INSERT INTO `tbl_category` (`user_id`,`cat_name`,`create_time`,`create_user_id`,`update_time`,`update_user_id`) VALUES ('2','Food:Groceries','','','','');
INSERT INTO `tbl_category` (`user_id`,`cat_name`,`create_time`,`create_user_id`,`update_time`,`update_user_id`) VALUES ('2','Food:Resturants','','','','');
INSERT INTO `tbl_category` (`user_id`,`cat_name`,`create_time`,`create_user_id`,`update_time`,`update_user_id`) VALUES ('2','Car:Gas','','','','');
INSERT INTO `tbl_category` (`user_id`,`cat_name`,`create_time`,`create_user_id`,`update_time`,`update_user_id`) VALUES ('2','House:Oil','','','','');
INSERT INTO `tbl_category` (`user_id`,`cat_name`,`create_time`,`create_user_id`,`update_time`,`update_user_id`) VALUES ('2','House:Rates','','','','');
INSERT INTO `tbl_category` (`user_id`,`cat_name`,`create_time`,`create_user_id`,`update_time`,`update_user_id`) VALUES ('2','House:Internet+Phone','','','','');
INSERT INTO `tbl_category` (`user_id`,`cat_name`,`create_time`,`create_user_id`,`update_time`,`update_user_id`) VALUES ('2','House:Maintenance','','','','');
