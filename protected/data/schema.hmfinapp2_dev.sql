...
-- ('','','','','','','','','');
-- INSERT INTO `tbl_account` (`id`,`user_id`,`acc_name`,`acc_type`,`acc_balance`,`create_time`,`create_user_id`,`update_time`,`update_user_id`) VALUES
-- ('','','','','','','','','');
-- INSERT INTO `tbl_payee` (`id`,`user_id`,`pay_name`,`create_time`,`create_user_id`,`update_time`,`update_user_id`) VALUES
-- ('','','','','','','');
...
-- ('','','','','','','','','','','','');
-- INSERT INTO `tbl_category` (`id`,`user_id`,`cat_name`,`create_time`,`create_user_id`,`update_time`,`update_user_id`) VALUES
-- ('','','','','','','');
